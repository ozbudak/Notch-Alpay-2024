...
getScore = @(parameters)getscoredC3cond(parameters,pb1, pb2);
...
getScore1 = @(parameters)getscoredCNPF3cond(parameters,pb1, pb2);
count1=1;
j=0;
sync1=zeros(1,2);
while count1<=50
...
saveas(figure(1), '3 conditions.png');
name="Pass_ttest_3.mat";
